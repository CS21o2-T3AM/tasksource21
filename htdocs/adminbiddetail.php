...
<div class="container">
    ...
    <div class="row">
       ...
       <form name='Information'  method='POST'  action=''>  
    	...
    	<div id='bid-information-container' class='col-sm-6 col-md-6 col-lg-6 col-xl-6'>
    	 ...
    	 <div id='bidder-information-container' class='col-sm-6 col-md-6 col-lg-6 col-xl-6'>
    	 	 <h3>Task Bidder</h3>
    	    <table class='table table-bordered table-striped table-hover'>
    	  ...
    	  <div id='task-information-container' class='col-sm-6 col-md-6 col-lg-6 col-xl-6'>
    	 ...
    	 <div id ='task-owner-information-container' class='col-sm-6 col-md-6 col-lg-6 col-xl-6'>
    	  <h3>Task Owner</h3>
    	    <table class='table table-bordered table-striped table-hover'>
    	        ...
    	        <div id='menu' align='right' style='padding-left: 5px'>
