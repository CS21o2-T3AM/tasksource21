...
//                        $address, $start_dt_data, $end_dt_data, $suggested_price, $bidding_deadline_data, $task_id);
...
<!--                                       value="--><?php //echo isset($start_dt)? $start_dt->format($php_to_html_date_format): ''; ?><!--">-->
<!--                            </div>-->
<!---->
...
<!--                                       value="--><?php //echo isset($end_dt)? $end_dt->format($php_to_html_date_format): ''; ?><!--">-->
<!--                            </div>-->
<!---->
<!---->
...
<!--                                       value="--><?php //echo isset($bidding_deadline)? $bidding_deadline->format($php_to_html_date_format): ''; ?><!--">-->
<!--                            </div>-->
<!---->
<!--                        </fieldset> <!--price-->-->
<!--                    </div> <!-- col -->-->
